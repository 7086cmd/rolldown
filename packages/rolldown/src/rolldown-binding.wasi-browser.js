...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingAmdOptions_struct_10']?.()
  __napiInstance.exports['__napi_register__BindingOutputOptions_struct_11']?.()
  __napiInstance.exports['__napi_register__BindingPluginContext_struct_12']?.()
  __napiInstance.exports['__napi_register__BindingPluginContext_impl_18']?.()
  __napiInstance.exports['__napi_register__BindingPluginContextResolvedId_struct_19']?.()
  __napiInstance.exports['__napi_register__BindingPluginOptions_struct_20']?.()
  __napiInstance.exports['__napi_register__BindingPluginWithIndex_struct_21']?.()
  __napiInstance.exports['__napi_register__BindingTransformPluginContext_struct_22']?.()
  __napiInstance.exports['__napi_register__BindingTransformPluginContext_impl_24']?.()
  __napiInstance.exports['__napi_register__BindingAssetSource_struct_25']?.()
  __napiInstance.exports['__napi_register__BindingEmittedAsset_struct_26']?.()
  __napiInstance.exports['__napi_register__BindingHookLoadOutput_struct_27']?.()
  __napiInstance.exports['__napi_register__BindingHookRenderChunkOutput_struct_28']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdExtraArgs_struct_29']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdOutput_struct_30']?.()
  __napiInstance.exports['__napi_register__BindingHookSideEffects_31']?.()
  __napiInstance.exports['__napi_register__BindingHookTransformOutput_struct_32']?.()
  __napiInstance.exports['__napi_register__BindingStringOrRegex_struct_33']?.()
  __napiInstance.exports['__napi_register__BindingPluginContextResolveOptions_struct_34']?.()
  __napiInstance.exports['__napi_register__BindingTransformHookExtraArgs_struct_35']?.()
  __napiInstance.exports['__napi_register__BindingBuiltinPlugin_struct_36']?.()
  __napiInstance.exports['__napi_register__BindingBuiltinPluginName_37']?.()
  __napiInstance.exports['__napi_register__BindingGlobImportPluginConfig_struct_38']?.()
